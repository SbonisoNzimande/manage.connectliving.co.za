$(document).ready(function(){
	...
	$('#PrintJobModal').on('show.bs.modal', function(e) {// on modal open
		...
		$.get('AllJobs/GetPrintJob', data, function(response){
	...
	$("#deleteQueryForm").on( 'submit', function(ev) {
		...
		console.log('Delete: ' + form_data);
	 	...
	 	$.post('AllJobs/DeleteJob', form_data, function(response){
	...
	$("#MarkDone").click(function(){
		...
		if(proceed) {// Check to proceed
		    ...
		    $.post('AllJobs/MarkDone', post_data, function(response){
	...
	function get_query_byid(data_url){
		...
		$.get('AllJobs/GetJobByID', data_url, function(response){
	...
	function show_cards(prop_id) {
		...
		$.ajax({
			type: "GET",
			dataType: 'json',
			url: 'AllJobs/GetAllCards?prop_id='+prop_id,
			error: function () {
	...
	function get_job_status_enums(iddiv, job_status){
		$.get('AllJobs/GetJobStatusEnums', '', function(response){
			var level_select = '<option></option>';
	...
	$('#EmailSupplierModal').on('show.bs.modal', function(e) {// on modal open
		...
		$.get('AllJobs/GetSupplierEmail', data, function(response){
			console.log(response);
	...
	$("#MarkJobForm").on( 'submit', function(e) {
		...
		var form_data = $("#MarkJobForm").serialize();
	 	...
	 	$.post('AllJobs/UpdateJobStatus', form_data, function(response){
	...
	$("#FilterForm").on( 'submit', function(e) {
		...
		var form_data = $("#FilterForm").serialize()+'&prop_id='+prop_id;
	 	...
	 	$.get('AllJobs/GetFilterCards', form_data, function(response){
	...
	$("#EmailForm").on( 'submit', function(e) {
		...
		var form_data = $("#EmailForm").serialize();
	 	...
	 	$.post('AllJobs/SendSupplierEmail', form_data, function(response){
	...
	$("#AssignForm").on( 'submit', function(ev) {
		...
		console.log('Creating new asset: ' + form_data);
	 	...
	 	$.post('AllJobs/AssignUser', form_data, function(response){
	...
	$("#UpdateJobForm").on('submit', function(ev) {
		...
		console.log('Updating Job: ' + form_data);
	 	...
	 	$.post('AllJobs/UpdateJob', form_data, function(response){
	...
	$("#SMSForm").on( 'submit', function(ev) {
		...
		console.log('Send SMS: ' + id);
	 	...
	 	$.post('AllJobs/SendSMS', form_data, function(response){
	...
	$("#SMSSupplierForm").on( 'submit', function(ev) {
		...
		console.log('Send SMS: ' + id);
	 	...
	 	$.post('AllJobs/SendSupplierSMS', form_data, function(response){
	...
	function get_timeline (id) {
		...
		$.ajax({
			type: "GET",
			dataType: 'json',
			url: 'AllJobs/GetTimeline?JobID=' + id,
			...
			success: function (dataobj) {
				...
				$.each(dataobj, function(key, value){
					...
					if (value.file) {
						card += '  	<div class="p">';
						card += '  		<a class="btn btn-sm btn-addon btn-info" href="AllJobs/DownloadFile/?file_name='+value.file+'&JobID='+id+'"><i class="fa fa-paperclip"></i>View File</a>';
					}
